...
def sendurl(SENDURL):
	...
	c.setopt(pycurl.WRITEDATA, indexfile) #将返回的HTML定向到indexfile文件对象
	...
	CONNECT_TIME = c.getinfo(c.CONNECT_TIME) #获取建立了解时间
	PRETRANSFER_TIME = c.getinfo(c.PRETRANSFER_TIME)#获取建立连接到准备传输消耗的时间
...
if __name__ == '__main__':
	SENDURL = sys.argv[1]   #zabbix传过来的第一个参数
	sendurl(SENDURL)
